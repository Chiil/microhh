...
Boundary_surface_user::Boundary_surface_user(Model* modelin, Input* inputin) : Boundary_surface(modelin, inputin)
{
    swboundary = "surface_user";
}

void Boundary_surface_user::init(Input* inputin)
{
    Boundary_surface::init(inputin);
...
void Boundary_surface_user::set_bc_patch(double* restrict a, double* restrict agrad, double* restrict aflux, int sw, double aval, double visc, double offset,
