...
b_turbt  = stats.variables["b_turb"][start:end,:]
b_visct  = stats.variables["b_visc"][start:end,:]
...
b_turb = numpy.mean(b_turbt,0)
b_visc = numpy.mean(b_visct,0)
b_resid = b_turb + b_visc
...
if(plotens):
  for n in range(end-start):
    plot(yplus[starty:endy], u_turbt [n,starty:endy] * visc / ustar**3, color='#cccccc')
    plot(yplus[starty:endy], u_visct [n,starty:endy] * visc / ustar**3, color='#cccccc')
    plot(yplus[starty:endy], u_lst   [n,starty:endy] * visc / ustar**3, color='#cccccc')
plot(yplus[starty:endy], u_turb [starty:endy] * visc / ustar**3, 'g-', label='Tt')
plot(yplus[starty:endy], u_visc [starty:endy] * visc / ustar**3, 'c-', label='Tv')
plot(yplus[starty:endy], u_ls   [starty:endy] * visc / ustar**3, 'b-', label='Fls')
plot(yplus[starty:endy], u_resid[starty:endy] * visc / ustar**3, 'k--', label='resid')
xlabel('y+')
ylabel('u+')
...
if(plotens):
  for n in range(end-start):
    plot(yplush[starty:endy], w_turbt[n,starty:endy] * visc / ustar**3, color='#cccccc')
    plot(yplush[starty:endy], w_prest[n,starty:endy] * visc / ustar**3, color='#cccccc')
    plot(yplush[starty:endy], w_buoyt[n,starty:endy] * visc / ustar**3, color='#cccccc')
plot(yplush[starty:endy], w_turb [starty:endy] * visc / ustar**3, 'g-' , label='Tt')
plot(yplush[starty:endy], w_pres [starty:endy] * visc / ustar**3, 'c-' , label='Tv')
plot(yplush[starty:endy], w_buoy [starty:endy] * visc / ustar**3, 'b-' , label='Fbuoy')
plot(yplush[starty:endy], w_resid[starty:endy] * visc / ustar**3, 'k--', label='resid')
xlabel('y+')
ylabel('w+')
legend(loc=0, ncol=2, frameon=False)
grid()
...
if(plotens):
  for n in range(end-start):
    plot(yplus[starty:endy], b_turbt [n,starty:endy] * visc / ustar**3, color='#cccccc')
    plot(yplus[starty:endy], b_visct [n,starty:endy] * visc / ustar**3, color='#cccccc')
plot(yplus[starty:endy], b_turb [starty:endy] * visc / ustar**3, 'g-', label='Tt')
plot(yplus[starty:endy], b_visc [starty:endy] * visc / ustar**3, 'c-', label='Tv')
plot(yplus[starty:endy], b_resid[starty:endy] * visc / ustar**3, 'k--', label='resid')
xlabel('y+')
ylabel('b+')
legend(loc=0, ncol=2, frameon=False)
grid()
...
if(plotens):
  for n in range(end-start):
    plot(yplush[starty:endy], uw_sheart[n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_turbt [n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_visct [n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_disst [n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_prest [n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_rdstrt[n,starty:endy] * visc / ustar**4., color='#cccccc')
    plot(yplush[starty:endy], uw_buoyt [n,starty:endy] * visc / ustar**4., color='#cccccc')
plot(yplush[starty:endy], uw_shear[starty:endy] * visc / ustar**4., 'b-', label='S')
plot(yplush[starty:endy], uw_turb [starty:endy] * visc / ustar**4., 'g-', label='Tt')
plot(yplush[starty:endy], uw_visc [starty:endy] * visc / ustar**4., 'c-', label='Tv')
plot(yplush[starty:endy], uw_diss [starty:endy] * visc / ustar**4., 'r-', label='D')
plot(yplush[starty:endy], uw_pres [starty:endy] * visc / ustar**4., 'y-', label='Tp')
plot(yplush[starty:endy], uw_rdstr[starty:endy] * visc / ustar**4., 'm-', label='P')
plot(yplush[starty:endy], uw_buoy [starty:endy] * visc / ustar**4., 'k-', label='B')
plot(yplush[starty:endy], uw_resid[starty:endy] * visc / ustar**4., 'k--', label='resid')
xlabel('y+')
ylabel('Rxz')
legend(loc=0, ncol=2, frameon=False)
grid()
...
if(plotens):
  for n in range(end-start):
    plot(yplush[starty:endy], bw_sheart[n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_turbt [n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_visct [n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_buoyt [n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_rdstrt[n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_disst [n,starty:endy] / bfluxt[n,0], color='#cccccc')
    plot(yplush[starty:endy], bw_prest [n,starty:endy] / bfluxt[n,0], color='#cccccc')
